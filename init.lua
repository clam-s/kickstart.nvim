...
require('lazy').setup({
  ...
  -- NOTE: Plugins can also be added by using a table,
  {
    ...
    config = function()
      require('code_runner').setup {
        fpython = 'python3 -u ' .. vim.fn.expand '%', -- Run Python files
        lua = 'lua ' .. vim.fn.expand '%', -- Run Lua files
        cpp = 'g++ -o ' .. vim.fn.expand '%:r' .. ' ' .. vim.fn.expand '%' .. ' && ./' .. vim.fn.expand '%:r', -- Compile and run C++ files
  ...
  {
    'tpope/vim-surround',
    lazy = true, -- Load the plugin lazily (optional)
  },
  {
